...
# forecast_weather documentation build
...
from forecast_weather import __version__ as release

# -- Project information -----------------------------------------------------

project = "forecast_weather"
author = "Kedro"
...
htmlhelp_basename = "forecast_weatherdoc"
...
latex_documents = [
    (
        master_doc,
        "forecast_weather.tex",
        "forecast_weather Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "forecast_weather",
        "Project forecast_weather codebase.",
        "Data-Science",
    )
]
